...
public class CharRange {
	...
	public boolean isSingleton() { return !isEmpty() && start == end; }
	public char getSingleton() { return start; }
	...
	public List<CharRange> getSubtraction(CharRange other) {
		...
		if( i.start > this.start )
			result.add(new CharRange(start, i.start));
		
		if( i.end < this.end )
			result.add(new CharRange(i.end, end));
